...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|FASYILA|❤',
    ...
    pages: [
        ...
        {
            image: './image/bukudepan.jpg', // Cover
        },
        {
        ...
        // --- Lembar 4 (data-page="3") ---
        {
            ...
            content: 'I will always be here for you.'
        },
        {
            image: './image/img13.jpg',
        },

        // --- Lembar 5 (data-page="4") ---
        {
            image: './image/img14.jpg',
            content: 'Love you forever!'
        },
        {
            image: './image/img15.jpg',
        }
...
const musicOptions = [
    ...
    { value: './music/music3.mp3', label: 'Music 3' }
];
const gifOptions = [
    { value: '', label: 'None' },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            {
                image: './image/img14.jpg',
                content: 'Happy Birthday Fasyila💗'
            },
            {
                image: './image/img15.jpg',
            },
